        ...
        <Link to="/" className="flex items-center space-x-2">
          ...
          <div className="flex flex-col items-start">
            <div className="flex items-center">
              <span className="text-xs tracking-widest text-carnivore-secondary mr-1">RECIPE</span>
              <span className="text-xs tracking-widest text-carnivore-secondary">ON THE GO</span>
            </div>
            <span className="font-bold text-carnivore-primary tracking-wider text-xl">
              CARNIVORE
            </span>
          </div>
        </Link>
